...
import { LayoutDashboard, MapPin, Route, TrainFront, Armchair, CalendarDays, ShieldCheck, ShieldAlert, ClipboardList } from 'lucide-react';
const sections = [['dashboard', 'Overview', LayoutDashboard], ['stations', 'Stations', MapPin], ['routes', 'Routes', Route], ['trains', 'Trains', TrainFront], ['seats', 'Seats', Armchair], ['schedules', 'Schedules', CalendarDays], ['fraud', 'Fraud monitoring', ShieldAlert], ['audit-logs', 'Audit logs', ClipboardList]];
